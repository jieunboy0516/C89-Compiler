...
{
  "$end", "error", "$undefined", "KW_INT", "KW_RETURN", "T_NUMBER",
  "T_LSQUAREBRACKET", "T_RSQUAREBRACKET", "T_LBRACKET", "T_RBRACKET",
  "T_LCURLYBRACKET", "T_RCURLYBRACKET", "T_SEMICOLON", "T_DECIMAL_CONST",
  "T_OCTAL_CONST", "T_HEX_CONST", "T_CHAR_CONST", "T_IDENTIFIER", "T_E",
  "T_SUFFIX_F", "T_SUFFIX_L", "T_SUFFIX_U", "T_DOUBLE_QUOTE",
  "T_SINGLE_QUOTE", "T_LITERAL_STRING", "T_PLUS", "T_MINUS", "T_TIMES",
  "T_DIVIDE", "T_EXPONENT", "$accept", "ROOT", "TOPLEVEL", "FUNCTION_DEF",
...
{
      -2,   -15,     2,    -2,   -15,   -14,   -15,   -15,    -3,    -5,
      -1,     4,   -15,    -7,    -4,   -15,   -15,   -15,     0,   -15,
     -15,   -15,   -15
};
...
{
       0,    13,     0,     2,     3,     0,     1,     4,     0,     0,
       0,     0,     5,     0,     0,     7,     9,    12,     0,    11,
       6,     8,    10
};
...
{
      13,     1,     6,     8,    10,     9,    17,    20,    13,    11,
       7,     0,    22,     0,     0,    21
};

static const yytype_int8 yycheck[] =
{
       4,     3,     0,    17,     9,     8,    13,    11,     4,    10,
       3,    -1,    12,    -1,    -1,    14
};
...
{
       0,     3,    31,    32,    33,    40,     0,    33,    17,     8,
       9,    10,    34,     4,    35,    36,    37,    13,    38,    39,
      11,    36,    12
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2:
#line 70 "src/c_small.y"
               { g_root = (yyvsp[0].FuncDefPtr);}
#line 1371 "bin/c_small.tab.cpp"
    break;

  case 3:
#line 73 "src/c_small.y"
                       {(yyval.FuncDefPtr) = (yyvsp[0].FuncDefPtr);}
#line 1377 "bin/c_small.tab.cpp"
    break;

  case 4:
#line 74 "src/c_small.y"
                                {(yyval.FuncDefPtr) = (yyvsp[0].FuncDefPtr);}
#line 1383 "bin/c_small.tab.cpp"
    break;

  case 5:
#line 77 "src/c_small.y"
                                                                         {(yyval.FuncDefPtr) = new FuncDef(*(yyvsp[-4].str), *(yyvsp[-3].str), (yyvsp[0].CompoundStatPtr));}
#line 1389 "bin/c_small.tab.cpp"
    break;
